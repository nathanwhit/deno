...
//!
//! This crate provides raw FFI bindings to libuv v1.51.0 (generated by
//! bindgen) plus safe Rust wrappers for the event loop and common handle
//! types.
