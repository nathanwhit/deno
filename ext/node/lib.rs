...
deno_core::extension!(deno_node,
  ...
  ops = [
    ...
    ops::net::op_uv_net_connect_tcp,
    ops::net::op_uv_net_listen_tcp,
    ops::net::op_uv_net_accept_tcp,
    ops::net::op_uv_net_read,
    ops::net::op_uv_net_write,
    ops::net::op_uv_net_ref,
    ops::net::op_uv_net_unref,
    ops::net::op_uv_net_get_fd,
    ops::net::op_uv_net_listener_ref,
    ops::net::op_uv_net_listener_unref,
