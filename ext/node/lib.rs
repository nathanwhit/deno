...
deno_core::extension!(deno_node,
  ...
  ops = [
    ...
    ops::fs::op_node_fs_close_async,
    ops::fs::op_node_fs_read_v_sync,
    ops::fs::op_node_fs_read_deferred,
    ops::fs::op_node_fs_write_sync,
    ops::fs::op_node_fs_write_v_sync,
    ops::fs::op_node_fs_write_v,
    ops::fs::op_node_fs_writev_sync,
    ops::fs::op_node_fs_writev,
    ops::fs::op_node_fs_write_file_sync,
    ops::fs::op_node_fs_write_file,
    ops::fs::op_node_fs_append_file_sync,
    ops::fs::op_node_fs_append_file,
    ops::fs::op_node_fs_truncate_sync,
    ops::fs::op_node_fs_truncate,
    ops::fs::op_node_fs_write_deferred,
    ops::fs::op_node_fs_seek_sync,
    ops::fs::op_node_fs_seek,
    ops::fs::op_node_fs_stat_sync,
    ops::fs::op_node_fs_stat,
    ops::fs::op_node_fs_lstat_sync,
    ops::fs::op_node_fs_lstat,
    ops::fs::op_node_fs_fstat_stats_sync,
    ops::fs::op_node_fs_fstat_stats,
    ops::fs::op_node_fs_stat_watcher_open,
    ops::fs::op_node_fs_stat_watcher_poll,
    ops::fs::op_node_fs_mkdir_sync,
    ops::fs::op_node_fs_mkdir,
    ops::fs::op_node_fs_remove_sync,
    ops::fs::op_node_fs_remove,
    ops::fs::op_node_fs_rm_sync,
    ops::fs::op_node_fs_rm,
    ops::fs::op_node_fs_rename_sync,
    ops::fs::op_node_fs_rename,
    ops::fs::op_node_fs_realpath_sync,
    ops::fs::op_node_fs_realpath,
    ops::fs::op_node_fs_set_buffer_prototype,
    ops::fs::op_node_fs_validate_watch_ignore,
    ops::fs::op_node_fs_encode_watch_filename,
    ops::fs::op_node_fs_read_link_sync,
    ops::fs::op_node_fs_read_link,
    ops::fs::op_node_fs_chmod_sync,
    ops::fs::op_node_fs_chmod,
    ops::fs::op_node_fs_chown_sync,
    ops::fs::op_node_fs_chown,
    ops::fs::op_node_fs_link_sync,
    ops::fs::op_node_fs_link,
    ops::fs::op_node_fs_symlink_sync,
    ops::fs::op_node_fs_symlink,
    ops::fs::op_node_fs_copy_file_sync,
    ops::fs::op_node_fs_copy_file,
    ops::fs::op_node_fs_utime_sync,
    ops::fs::op_node_fs_utime,
    ops::fs::op_node_fs_access_sync,
    ops::fs::op_node_fs_access,
    ops::fs::op_node_fs_dirent,
    ops::fs::op_node_fs_dirent_from_stats,
    ops::fs::op_node_fs_readdir_sync,
    ops::fs::op_node_fs_opendir_sync,
    ops::fs::op_node_fs_readdir,
    ...
    ops::fs::op_node_fs_read_file_path_sync,
    ops::fs::op_node_fs_read_file_path,
    ops::fs::op_node_fs_readv_sync,
    ops::fs::op_node_fs_readv,
    ops::fs::op_node_fs_read_file,
    ops::fs::op_node_fs_fstat_sync,
    ops::fs::op_node_fs_encode_bytes,
    ops::fs::op_node_cp_check_paths_recursive,
    ops::fs::op_node_cp_on_file,
    ops::fs::op_node_cp_on_link,
    ops::fs::op_node_cp_fast,
    ...
    ops::v8::op_v8_set_heap_snapshot_near_heap_limit,
