import { GoTrueClient } from 'https://esm.sh/v135/@supabase/gotrue-js@2.57.0/dist/module/index.d.ts';
import { RealtimeClientOptions } from 'https://esm.sh/v135/@supabase/realtime-js@2.8.4/dist/module/index.d.ts';
