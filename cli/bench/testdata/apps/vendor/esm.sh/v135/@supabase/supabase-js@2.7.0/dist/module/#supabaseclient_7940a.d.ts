import { FunctionsClient } from 'https://esm.sh/v135/@supabase/functions-js@2.1.5/dist/module/index.d.ts';
import { PostgrestClient, PostgrestFilterBuilder, PostgrestQueryBuilder } from 'https://esm.sh/v135/@supabase/postgrest-js@1.9.0/dist/module/index.d.ts';
import { RealtimeChannel, RealtimeChannelOptions, RealtimeClient } from 'https://esm.sh/v135/@supabase/realtime-js@2.8.4/dist/module/index.d.ts';
import { StorageClient as SupabaseStorageClient } from 'https://esm.sh/v135/@supabase/storage-js@2.5.4/dist/module/index.d.ts';
