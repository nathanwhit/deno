import {ConfigurationServicePlaceholders, ConfigurationServiceApiVersions} from './config_service_placeholders.d.ts';
import {ConfigBase, ConfigurationOptions} from './config-base.d.ts';
...
export { ConfigBase } from "./config-base.d.ts";
