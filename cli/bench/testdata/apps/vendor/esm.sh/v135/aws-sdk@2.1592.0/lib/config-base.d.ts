import {Agent as httpAgent} from 'https://esm.sh/v135/@types/node@20.11.20/http.d.ts';
import {Agent as httpsAgent} from 'https://esm.sh/v135/@types/node@20.11.20/https.d.ts';
import {AWSError} from './error.d.ts';
import {Credentials, CredentialsOptions} from './credentials.d.ts';
import {CredentialProviderChain} from './credentials/credential_provider_chain.d.ts';
import {Token} from './token.d.ts';
import {TokenProviderChain} from './token/token_provider_chain.d.ts';
