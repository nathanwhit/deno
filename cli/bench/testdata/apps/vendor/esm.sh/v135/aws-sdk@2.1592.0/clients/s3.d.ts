...
import {S3Customizations} from '../lib/services/s3.d.ts';
import {WaiterConfiguration} from '../lib/service.d.ts';
import {ServiceConfigurationOptions} from '../lib/service.d.ts';
import {ConfigBase as Config} from '../lib/config-base.d.ts';
import {UseDualstackConfigOptions} from '../lib/config_use_dualstack.d.ts';
import {EventStream} from '../lib/event-stream/event-stream.d.ts';
import {ManagedUpload as managed_upload} from '../lib/s3/managed_upload.d.ts';
import {PresignedPost as presigned_post} from '../lib/s3/presigned_post.d.ts';
