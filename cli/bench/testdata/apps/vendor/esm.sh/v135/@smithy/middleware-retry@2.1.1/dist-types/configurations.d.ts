import { LoadedConfigSelectors } from "https://esm.sh/v135/@smithy/node-config-provider@2.2.1/dist-types/index.d.ts";
import { Provider, RetryStrategy, RetryStrategyV2 } from "https://esm.sh/v135/@smithy/types@2.9.1/dist-types/index.d.ts";
