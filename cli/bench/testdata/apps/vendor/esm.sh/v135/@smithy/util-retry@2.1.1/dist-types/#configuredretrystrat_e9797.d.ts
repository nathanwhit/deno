import type { Provider, RetryBackoffStrategy, RetryErrorInfo, RetryStrategyV2, StandardRetryToken } from "https://esm.sh/v135/@smithy/types@2.9.1/dist-types/index.d.ts";
import { StandardRetryStrategy } from "./StandardRetryStrategy.d.ts";
/**
 * @public
 *
