...
import { PutObjectTaggingOutput, PutObjectTaggingRequest } from "../models/models_1.d.ts";
...
declare const PutObjectTaggingCommand_base: {
    new (input: PutObjectTaggingCommandInput): import("https://esm.sh/v135/@smithy/smithy-client@2.3.1/dist-types/index.d.ts").CommandImpl<PutObjectTaggingCommandInput, PutObjectTaggingCommandOutput, S3ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
