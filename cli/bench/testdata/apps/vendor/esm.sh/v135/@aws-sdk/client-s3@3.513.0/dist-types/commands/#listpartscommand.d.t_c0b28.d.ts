...
import { ListPartsOutput, ListPartsRequest } from "../models/models_0.d.ts";
...
declare const ListPartsCommand_base: {
    new (input: ListPartsCommandInput): import("https://esm.sh/v135/@smithy/smithy-client@2.3.1/dist-types/index.d.ts").CommandImpl<ListPartsCommandInput, ListPartsCommandOutput, S3ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
