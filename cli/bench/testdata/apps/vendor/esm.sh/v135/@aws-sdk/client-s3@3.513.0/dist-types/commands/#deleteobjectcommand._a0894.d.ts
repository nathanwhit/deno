...
import { DeleteObjectOutput, DeleteObjectRequest } from "../models/models_0.d.ts";
...
declare const DeleteObjectCommand_base: {
    new (input: DeleteObjectCommandInput): import("https://esm.sh/v135/@smithy/smithy-client@2.3.1/dist-types/index.d.ts").CommandImpl<DeleteObjectCommandInput, DeleteObjectCommandOutput, S3ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
