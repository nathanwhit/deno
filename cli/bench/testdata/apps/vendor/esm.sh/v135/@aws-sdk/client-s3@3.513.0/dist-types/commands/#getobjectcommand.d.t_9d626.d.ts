...
import { GetObjectOutput, GetObjectRequest } from "../models/models_0.d.ts";
...
declare const GetObjectCommand_base: {
    new (input: GetObjectCommandInput): import("https://esm.sh/v135/@smithy/smithy-client@2.3.1/dist-types/index.d.ts").CommandImpl<GetObjectCommandInput, GetObjectCommandOutput, S3ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
