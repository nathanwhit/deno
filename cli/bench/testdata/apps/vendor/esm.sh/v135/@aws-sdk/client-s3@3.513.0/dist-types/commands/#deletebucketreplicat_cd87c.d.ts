...
import { DeleteBucketReplicationRequest } from "../models/models_0.d.ts";
...
declare const DeleteBucketReplicationCommand_base: {
    new (input: DeleteBucketReplicationCommandInput): import("https://esm.sh/v135/@smithy/smithy-client@2.3.1/dist-types/index.d.ts").CommandImpl<DeleteBucketReplicationCommandInput, DeleteBucketReplicationCommandOutput, S3ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
