...
import { DeleteObjectsOutput, DeleteObjectsRequest } from "../models/models_0.d.ts";
...
declare const DeleteObjectsCommand_base: {
    new (input: DeleteObjectsCommandInput): import("https://esm.sh/v135/@smithy/smithy-client@2.3.1/dist-types/index.d.ts").CommandImpl<DeleteObjectsCommandInput, DeleteObjectsCommandOutput, S3ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
