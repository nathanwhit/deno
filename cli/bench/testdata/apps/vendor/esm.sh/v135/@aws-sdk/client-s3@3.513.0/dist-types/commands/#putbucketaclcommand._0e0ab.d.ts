...
import { PutBucketAclRequest } from "../models/models_0.d.ts";
...
declare const PutBucketAclCommand_base: {
    new (input: PutBucketAclCommandInput): import("https://esm.sh/v135/@smithy/smithy-client@2.3.1/dist-types/index.d.ts").CommandImpl<PutBucketAclCommandInput, PutBucketAclCommandOutput, S3ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
