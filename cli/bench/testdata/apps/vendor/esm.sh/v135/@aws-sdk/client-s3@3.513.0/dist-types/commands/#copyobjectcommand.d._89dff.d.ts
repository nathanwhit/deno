...
import { CopyObjectOutput, CopyObjectRequest } from "../models/models_0.d.ts";
...
declare const CopyObjectCommand_base: {
    new (input: CopyObjectCommandInput): import("https://esm.sh/v135/@smithy/smithy-client@2.3.1/dist-types/index.d.ts").CommandImpl<CopyObjectCommandInput, CopyObjectCommandOutput, S3ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
