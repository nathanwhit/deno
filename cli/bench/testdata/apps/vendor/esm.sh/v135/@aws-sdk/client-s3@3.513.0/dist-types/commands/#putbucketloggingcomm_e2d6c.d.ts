...
import { PutBucketLoggingRequest } from "../models/models_0.d.ts";
...
declare const PutBucketLoggingCommand_base: {
    new (input: PutBucketLoggingCommandInput): import("https://esm.sh/v135/@smithy/smithy-client@2.3.1/dist-types/index.d.ts").CommandImpl<PutBucketLoggingCommandInput, PutBucketLoggingCommandOutput, S3ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
