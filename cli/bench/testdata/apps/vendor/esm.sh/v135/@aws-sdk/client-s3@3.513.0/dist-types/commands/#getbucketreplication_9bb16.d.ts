...
import { GetBucketReplicationOutput, GetBucketReplicationRequest } from "../models/models_0.d.ts";
...
declare const GetBucketReplicationCommand_base: {
    new (input: GetBucketReplicationCommandInput): import("https://esm.sh/v135/@smithy/smithy-client@2.3.1/dist-types/index.d.ts").CommandImpl<GetBucketReplicationCommandInput, GetBucketReplicationCommandOutput, S3ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
