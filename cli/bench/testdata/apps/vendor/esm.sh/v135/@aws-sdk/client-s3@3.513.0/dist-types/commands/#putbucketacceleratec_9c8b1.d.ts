...
import { PutBucketAccelerateConfigurationRequest } from "../models/models_0.d.ts";
...
declare const PutBucketAccelerateConfigurationCommand_base: {
    new (input: PutBucketAccelerateConfigurationCommandInput): import("https://esm.sh/v135/@smithy/smithy-client@2.3.1/dist-types/index.d.ts").CommandImpl<PutBucketAccelerateConfigurationCommandInput, PutBucketAccelerateConfigurationCommandOutput, S3ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
