...
import { PutObjectOutput, PutObjectRequest } from "../models/models_1.d.ts";
...
declare const PutObjectCommand_base: {
    new (input: PutObjectCommandInput): import("https://esm.sh/v135/@smithy/smithy-client@2.3.1/dist-types/index.d.ts").CommandImpl<PutObjectCommandInput, PutObjectCommandOutput, S3ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
