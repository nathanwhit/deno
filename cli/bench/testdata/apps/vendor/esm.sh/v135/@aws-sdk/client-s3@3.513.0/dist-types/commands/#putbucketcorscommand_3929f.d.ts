...
import { PutBucketCorsRequest } from "../models/models_0.d.ts";
...
declare const PutBucketCorsCommand_base: {
    new (input: PutBucketCorsCommandInput): import("https://esm.sh/v135/@smithy/smithy-client@2.3.1/dist-types/index.d.ts").CommandImpl<PutBucketCorsCommandInput, PutBucketCorsCommandOutput, S3ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
