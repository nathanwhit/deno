...
import { GetBucketAclOutput, GetBucketAclRequest } from "../models/models_0.d.ts";
...
declare const GetBucketAclCommand_base: {
    new (input: GetBucketAclCommandInput): import("https://esm.sh/v135/@smithy/smithy-client@2.3.1/dist-types/index.d.ts").CommandImpl<GetBucketAclCommandInput, GetBucketAclCommandOutput, S3ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
