...
import { PutBucketReplicationRequest } from "../models/models_1.d.ts";
...
declare const PutBucketReplicationCommand_base: {
    new (input: PutBucketReplicationCommandInput): import("https://esm.sh/v135/@smithy/smithy-client@2.3.1/dist-types/index.d.ts").CommandImpl<PutBucketReplicationCommandInput, PutBucketReplicationCommandOutput, S3ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
