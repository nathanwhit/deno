...
import { PutBucketNotificationConfigurationRequest } from "../models/models_0.d.ts";
...
declare const PutBucketNotificationConfigurationCommand_base: {
    new (input: PutBucketNotificationConfigurationCommandInput): import("https://esm.sh/v135/@smithy/smithy-client@2.3.1/dist-types/index.d.ts").CommandImpl<PutBucketNotificationConfigurationCommandInput, PutBucketNotificationConfigurationCommandOutput, S3ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
