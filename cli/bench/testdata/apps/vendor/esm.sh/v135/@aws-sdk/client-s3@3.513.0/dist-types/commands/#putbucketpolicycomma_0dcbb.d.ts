...
import { PutBucketPolicyRequest } from "../models/models_0.d.ts";
...
declare const PutBucketPolicyCommand_base: {
    new (input: PutBucketPolicyCommandInput): import("https://esm.sh/v135/@smithy/smithy-client@2.3.1/dist-types/index.d.ts").CommandImpl<PutBucketPolicyCommandInput, PutBucketPolicyCommandOutput, S3ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
