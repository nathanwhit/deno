...
import { CreateBucketOutput, CreateBucketRequest } from "../models/models_0.d.ts";
...
declare const CreateBucketCommand_base: {
    new (input: CreateBucketCommandInput): import("https://esm.sh/v135/@smithy/smithy-client@2.3.1/dist-types/index.d.ts").CommandImpl<CreateBucketCommandInput, CreateBucketCommandOutput, S3ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
