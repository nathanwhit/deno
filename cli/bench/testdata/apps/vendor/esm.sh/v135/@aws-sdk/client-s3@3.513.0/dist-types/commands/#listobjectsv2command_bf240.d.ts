...
import { ListObjectsV2Output, ListObjectsV2Request } from "../models/models_0.d.ts";
...
declare const ListObjectsV2Command_base: {
    new (input: ListObjectsV2CommandInput): import("https://esm.sh/v135/@smithy/smithy-client@2.3.1/dist-types/index.d.ts").CommandImpl<ListObjectsV2CommandInput, ListObjectsV2CommandOutput, S3ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
