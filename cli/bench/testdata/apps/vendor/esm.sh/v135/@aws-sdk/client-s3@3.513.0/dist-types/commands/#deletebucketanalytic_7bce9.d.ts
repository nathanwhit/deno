...
import { DeleteBucketAnalyticsConfigurationRequest } from "../models/models_0.d.ts";
...
declare const DeleteBucketAnalyticsConfigurationCommand_base: {
    new (input: DeleteBucketAnalyticsConfigurationCommandInput): import("https://esm.sh/v135/@smithy/smithy-client@2.3.1/dist-types/index.d.ts").CommandImpl<DeleteBucketAnalyticsConfigurationCommandInput, DeleteBucketAnalyticsConfigurationCommandOutput, S3ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
