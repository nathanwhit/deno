...
import { PutBucketAnalyticsConfigurationRequest } from "../models/models_0.d.ts";
...
declare const PutBucketAnalyticsConfigurationCommand_base: {
    new (input: PutBucketAnalyticsConfigurationCommandInput): import("https://esm.sh/v135/@smithy/smithy-client@2.3.1/dist-types/index.d.ts").CommandImpl<PutBucketAnalyticsConfigurationCommandInput, PutBucketAnalyticsConfigurationCommandOutput, S3ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
