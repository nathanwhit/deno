...
import { MetadataBearer as __MetadataBearer, StreamingBlobPayloadInputTypes } from "https://esm.sh/v135/@smithy/types@2.9.1/dist-types/index.d.ts";
import { WriteGetObjectResponseRequest } from "../models/models_1.d.ts";
...
declare const WriteGetObjectResponseCommand_base: {
    new (input: WriteGetObjectResponseCommandInput): import("https://esm.sh/v135/@smithy/smithy-client@2.3.1/dist-types/index.d.ts").CommandImpl<WriteGetObjectResponseCommandInput, WriteGetObjectResponseCommandOutput, S3ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
