...
import { GetBucketLocationOutput, GetBucketLocationRequest } from "../models/models_0.d.ts";
...
declare const GetBucketLocationCommand_base: {
    new (input: GetBucketLocationCommandInput): import("https://esm.sh/v135/@smithy/smithy-client@2.3.1/dist-types/index.d.ts").CommandImpl<GetBucketLocationCommandInput, GetBucketLocationCommandOutput, S3ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
