...
import { UploadPartOutput, UploadPartRequest } from "../models/models_1.d.ts";
...
declare const UploadPartCommand_base: {
    new (input: UploadPartCommandInput): import("https://esm.sh/v135/@smithy/smithy-client@2.3.1/dist-types/index.d.ts").CommandImpl<UploadPartCommandInput, UploadPartCommandOutput, S3ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
