...
import { GetBucketCorsOutput, GetBucketCorsRequest } from "../models/models_0.d.ts";
...
declare const GetBucketCorsCommand_base: {
    new (input: GetBucketCorsCommandInput): import("https://esm.sh/v135/@smithy/smithy-client@2.3.1/dist-types/index.d.ts").CommandImpl<GetBucketCorsCommandInput, GetBucketCorsCommandOutput, S3ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
