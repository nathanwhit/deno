...
import { UploadPartCopyOutput, UploadPartCopyRequest } from "../models/models_1.d.ts";
...
declare const UploadPartCopyCommand_base: {
    new (input: UploadPartCopyCommandInput): import("https://esm.sh/v135/@smithy/smithy-client@2.3.1/dist-types/index.d.ts").CommandImpl<UploadPartCopyCommandInput, UploadPartCopyCommandOutput, S3ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
