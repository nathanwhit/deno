...
import { ListObjectsOutput, ListObjectsRequest } from "../models/models_0.d.ts";
...
declare const ListObjectsCommand_base: {
    new (input: ListObjectsCommandInput): import("https://esm.sh/v135/@smithy/smithy-client@2.3.1/dist-types/index.d.ts").CommandImpl<ListObjectsCommandInput, ListObjectsCommandOutput, S3ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
