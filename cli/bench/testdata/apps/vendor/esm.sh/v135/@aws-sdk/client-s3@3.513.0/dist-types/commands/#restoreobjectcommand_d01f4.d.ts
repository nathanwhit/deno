...
import { RestoreObjectOutput, RestoreObjectRequest } from "../models/models_1.d.ts";
...
declare const RestoreObjectCommand_base: {
    new (input: RestoreObjectCommandInput): import("https://esm.sh/v135/@smithy/smithy-client@2.3.1/dist-types/index.d.ts").CommandImpl<RestoreObjectCommandInput, RestoreObjectCommandOutput, S3ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
