...
import { PutObjectAclOutput, PutObjectAclRequest } from "../models/models_1.d.ts";
...
declare const PutObjectAclCommand_base: {
    new (input: PutObjectAclCommandInput): import("https://esm.sh/v135/@smithy/smithy-client@2.3.1/dist-types/index.d.ts").CommandImpl<PutObjectAclCommandInput, PutObjectAclCommandOutput, S3ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
