...
import { PutBucketInventoryConfigurationRequest } from "../models/models_0.d.ts";
...
declare const PutBucketInventoryConfigurationCommand_base: {
    new (input: PutBucketInventoryConfigurationCommandInput): import("https://esm.sh/v135/@smithy/smithy-client@2.3.1/dist-types/index.d.ts").CommandImpl<PutBucketInventoryConfigurationCommandInput, PutBucketInventoryConfigurationCommandOutput, S3ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
