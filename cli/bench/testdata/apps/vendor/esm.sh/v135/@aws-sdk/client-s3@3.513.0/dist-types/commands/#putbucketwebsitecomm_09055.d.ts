...
import { PutBucketWebsiteRequest } from "../models/models_1.d.ts";
...
declare const PutBucketWebsiteCommand_base: {
    new (input: PutBucketWebsiteCommandInput): import("https://esm.sh/v135/@smithy/smithy-client@2.3.1/dist-types/index.d.ts").CommandImpl<PutBucketWebsiteCommandInput, PutBucketWebsiteCommandOutput, S3ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
