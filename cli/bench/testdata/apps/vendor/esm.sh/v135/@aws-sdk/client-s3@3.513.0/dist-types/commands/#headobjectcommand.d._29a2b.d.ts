...
import { HeadObjectOutput, HeadObjectRequest } from "../models/models_0.d.ts";
...
declare const HeadObjectCommand_base: {
    new (input: HeadObjectCommandInput): import("https://esm.sh/v135/@smithy/smithy-client@2.3.1/dist-types/index.d.ts").CommandImpl<HeadObjectCommandInput, HeadObjectCommandOutput, S3ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
