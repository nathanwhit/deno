...
import { GetBucketWebsiteOutput, GetBucketWebsiteRequest } from "../models/models_0.d.ts";
...
declare const GetBucketWebsiteCommand_base: {
    new (input: GetBucketWebsiteCommandInput): import("https://esm.sh/v135/@smithy/smithy-client@2.3.1/dist-types/index.d.ts").CommandImpl<GetBucketWebsiteCommandInput, GetBucketWebsiteCommandOutput, S3ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
