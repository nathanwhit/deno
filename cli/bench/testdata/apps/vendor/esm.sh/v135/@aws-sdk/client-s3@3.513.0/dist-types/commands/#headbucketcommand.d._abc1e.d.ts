...
import { HeadBucketOutput, HeadBucketRequest } from "../models/models_0.d.ts";
...
declare const HeadBucketCommand_base: {
    new (input: HeadBucketCommandInput): import("https://esm.sh/v135/@smithy/smithy-client@2.3.1/dist-types/index.d.ts").CommandImpl<HeadBucketCommandInput, HeadBucketCommandOutput, S3ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
