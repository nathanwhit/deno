...
import { PutBucketTaggingRequest } from "../models/models_1.d.ts";
...
declare const PutBucketTaggingCommand_base: {
    new (input: PutBucketTaggingCommandInput): import("https://esm.sh/v135/@smithy/smithy-client@2.3.1/dist-types/index.d.ts").CommandImpl<PutBucketTaggingCommandInput, PutBucketTaggingCommandOutput, S3ClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
