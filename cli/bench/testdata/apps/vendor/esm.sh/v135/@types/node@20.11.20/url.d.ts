...
declare module "url" {
    ...
    import { ClientRequestArgs } from "https://esm.sh/v135/@types/node@20.11.20/http.d.ts";
    import { ParsedUrlQuery, ParsedUrlQueryInput } from "https://esm.sh/v135/@types/node@20.11.20/querystring.d.ts";
    // Input to `url.format`
    interface UrlObject {
...
declare module "https://esm.sh/v135/@types/node@20.11.20/url.d.ts" {
    export * from "url";
}
